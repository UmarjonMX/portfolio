          ...
          <div className="pt-10 border-t border-border-light dark:border-border-dark relative z-40">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <motion.a 
                ...
                className="flex items-center space-x-5 p-5 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl hover:border-[#08CB00] dark:hover:border-[#08CB00] hover:shadow-[0_0_20px_rgba(8,203,0,0.2)] transition-all group backdrop-blur-md cursor-pointer"
              >
                <img src="/icons/mail.png" alt="Email" style={{ width: 32, height: 32, objectFit: 'contain' }} className="group-hover:drop-shadow-[0_0_8px_#08CB00] dark:invert transition-all duration-300" />
                <div className="flex flex-col overflow-hidden">
                  <span className="font-martian font-bold text-lg group-hover:text-[#08CB00] transition-colors duration-300 leading-tight truncate">Email</span>
                  <span className="text-xs font-medium opacity-60 truncate">umarmx2008@gmail.com</span>
                </div>
              </motion.a>
