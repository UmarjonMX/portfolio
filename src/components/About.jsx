      ...
      <div className="relative z-10 max-w-4xl mx-auto mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <BentoCard className="h-full p-8 sm:p-10">
            <div className="font-martian text-[9px] font-bold text-accent uppercase tracking-widest mb-6 border-b border-primary-text/5 dark:border-primary-text-dark/10 pb-3 flex items-center gap-3">
              <span className="w-1.5 h-1.5 bg-accent rounded-full"></span>
              Focus Area 01
            </div>
            <h3 className="text-2xl font-bold mb-3 text-primary-text dark:text-primary-text-dark font-martian tracking-tight">
          ...
          <BentoCard className="h-full p-8 sm:p-10 md:col-span-1 bg-accent/5 dark:bg-accent/5 border-accent/20 dark:border-accent/20">
            <div className="font-martian text-[9px] font-bold text-accent uppercase tracking-widest mb-6 border-b border-accent/20 pb-3 flex items-center gap-3">
            ...
            <p className="text-base text-primary-text/90 dark:text-primary-text-dark/90 font-bold leading-relaxed font-funnel">
